...
//        clientService =new ClientService(repository,mapper );
//
//
//
//
...
//        //when
//        accountService.transfer(clientFrom.getId(),clientTo.getId(),amount);
//        //then
//        final Client actualclientfrom = clientService
//                .findByMail(emailFrom);
//        final Client actualcleientto = clientService
//                .findByMail(emailTo);
...
//        final String emailFrom= "mail@piotr";
//        final String emailTo=   "mail@pawel";
//        long  idFrom = repository.findByMail(emailFrom).getId();
//        long idTo = repository.findByMail(emailTo).getId();
//        double amount=-190;
...
//        final String emailFrom= "mail@piotr";
//        long id = repository.findByMail(emailFrom).getId();
//        //when then
//        Assertions.assertThrows(
//                IllegalArgumentException.class,() -> accountService.transfer(id,id,10)
//        );
//    }
//    @Test
//    public void showIfThatMailExistInBaseTest()
//    {
//        Client client = new Client("Tomek","Tomek@tomek",singletonList(new Account(3000,"PLN")));
//
//        Assertions.assertThrows(
//                NoSuchElementException.class,() -> clientService.findByMail(client.getMail())
//        );
//
//    }
////
