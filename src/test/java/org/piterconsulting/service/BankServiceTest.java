...
//    BankService service;
//    ClientRipository repository;
//
//    @BeforeEach
//    public void setup()
//    {
//        repository = mock(ClientRipository.class);
...
//        );
//        double amount=1000;
//        when(repository.findByEmail22(emailFrom)).thenReturn(clientFrom);
//        when(repository.findByEmail22(emailTo)).thenReturn(clientTo);
//        //when
...
//        when(repository.findByEmail22(email)).thenReturn(client);
//    //when
